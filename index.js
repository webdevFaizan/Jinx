...
const session= require('express-session');      //used to create an encrypted session cookie.
...
//server.js is used for using the .env file this will be used to make the important information of file like the api key or the DB_URL as hidden.
...
const sassMiddleware = require('node-sass-middleware');     //This middleware is used for the purpose of setting up the sass/scss and compile it to the final file that would be css.
